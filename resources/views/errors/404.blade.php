@extends('layout.user.main', ['is_error_page' => true])

@section('content')
    @php($is404 = true)
    <section class="new-main-container pt-20">
        <div class="flex md:flex-row flex-col items-center justify-between w-full  md:h-[70vh] h-auto mx-auto">
            <div class="md:text-start text-center md:mt-0 mt-[40px]  w-50">
                ...
                <a href="{{ route('home', app()->getLocale()) }}" class="flex md:justify-start justify-center w-full pt-8">
                    <span
                        class="block px-4 py-2 rounded-md bg-newprimary font-primary font-semibold text-base text-white text-center">
