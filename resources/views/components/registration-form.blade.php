...
@else
    <div class="absolute w-full h-full md:max-w-screen-xl mx-auto top-0 left-0 right-0">
        <div class="md:absolute fixed  {{ $isHome ? 'md:top-[50%] lg:right-[5rem] xl:right-[8.5rem]' : 'md:top-[55%] lg:right-[2.5rem] xl:right-[5rem]' }} md:-translate-y-[60%] md:right-20 -top-[100vh] right-4 md:z-[40] z-[99999] ease-in-out duration-700"
            id="registerForm">
