                                        ...
                                        <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                            <div class="col-md-2 col">
                                                ...
                                                <div class="col d-flex align-items-center justify-content-center border rounded" style="min-height: 110px">
                                                    <img class="img-preview img-fluid" id="img_preview" src="{{ asset('uploaded_files/blogs/'.$blog->blog_thumbnail) }}">
                                                </div>
                                            </div>
                                            <div class="col d-flex flex-column gap-2">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="alt_en" name="blog_alt" value="{{ $blog->blog_thumbnail_alt }}">
                                                    @error('blog_alt')
                                                        <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                                    @enderror
                                                </div>
