        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Competition Result</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="card-title">List Competition Result <span>| {{ now()->year }}</span></h5>
                                    <a type="button" class="btn btn-primary" href="/admin/competition-result/create">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body text-center mt-3 mb-1">
                    <p id="desc-info">Are you sure, you want to Delete this Competition Result?</p>
                </div>
    ...
    <script>
        ...
        function getData() {
            $('#listimportantdates').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('data-competition-result') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        function formDelete(id) {
            $('#form_delete').attr('action', '{{ url('/admin/competition-result/delete/') }}' + '/' + id);
        };
