                                ...
                                <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                    <div class="col-md-2 col">
                                        ...
                                        <div class="col d-flex align-items-center justify-content-center border rounded" style="min-height: 110px">
                                            <img class="img-preview img-fluid" id="img_preview" src="{{ asset('uploaded_files/'.'mentor/'.$mentor[0]->created_at->format('Y').'/'.$mentor[0]->created_at->format('m').'/'.$mentor[0]->mentor_picture) }}">
                                        </div>
                                    </div>
...
<script>
    ...
    function createSlug(){
        const firstname = document.getElementById('firstname').value.toLowerCase().replace(/[^a-zA-Z ]/g, "").split(' ').join('-');
        const lastname = document.getElementById('lastname').value.toLowerCase().replace(/[^a-zA-Z ]/g, "").split(' ').join('-');
