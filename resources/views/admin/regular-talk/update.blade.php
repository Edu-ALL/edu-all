                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('update-regular-talk', ['id' => $regular_talk->id]) }}" method="POST"
                                    ...
                                    <div class="col d-flex flex-column gap-2">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="topic" name="topic"
                                                value="{{ $regular_talk->topic }}" oninput="createSlug()">
                                            @error('topic')
                                        ...
                                        <div class="col row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select name="recommended_for" id=""
                                                    class="form-control form-select">
                                                    <option value="parents" {{ $regular_talk->recommended_for == 'parents' ? 'selected' : ''}} >Parents</option>
                                                    <option value="students" {{$regular_talk->recommended_for == 'students' ? 'selected' : ''}} >Students</option>
                                                    <option value="both" {{$regular_talk->recommended_for == 'both' ? 'selected' : ''}} >Both</option>
                                                </select>
