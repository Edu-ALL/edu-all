                            ...
                            <form action="{{ route('update-banner', ['id' => $banner->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col">
                                            <select class="select2" name="region" id="region" onchange="checkInput()">
                                                ...
                                                @foreach ($regions as $regions)
                                                    <option value="{{ $regions->region_id }}" {{ $banner->regions->region_id == $regions->region_id ? 'selected' : '' }}>
                                                        {{ $regions->region }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col">
                                            <select class="select2" name="lang" id="lang" onchange="checkInput()">
                                                ...
                                                @foreach ($languages as $languages)
                                                    <option value="{{ $languages->language_id }}" {{ $banner->languages->language_id == $languages->language_id ? 'selected' : '' }}>
                                                        {{ $languages->language }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                @if($errors->any())
                                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                        <strong>Failed Update Banner!</strong> You have to check some fields.
                                ...
                                <div class="col d-flex flex-column pt-2 gap-2">
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="alt" name="banner_alt" value="{{ $banner->banner_alt }}">
                                        @error('banner_alt')
                                            <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="banner_title" name="banner_title" value="{{ $banner->banner_title }}">
                                        @error('banner_title')
                                            <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    {{-- <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="banner_button" name="banner_button" value="{{ $banner->banner_button }}">
                                        @error('banner_button')
                                            <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                        @enderror
                                    </div> --}}
                                    <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                        ...
                                        <div class="col-md-4 col">
                                            ...
                                            <input type="color" class="form-control pick-color" id="banner_button_color" name="banner_button_color" value="{{ $banner->banner_button_color }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form-control" id="banner_link" name="banner_link" value="{{ $banner->banner_link }}">
                                        @error('banner_link')
                                            <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                        @enderror
                                    </div>
