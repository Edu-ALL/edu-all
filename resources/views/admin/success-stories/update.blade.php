                                    ...
                                    <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                        <div class="col-md-2 col">
                                            ...
                                            <div class="col d-flex align-items-center justify-content-center border rounded" style="min-height: 110px">
                                                <img class="img-preview img-fluid" id="img_preview" src="{{ asset('uploaded_files/'.'success-stories/'.$success_stories[0]->created_at->format('Y').'/'.$success_stories[0]->created_at->format('m').'/'.$success_stories[0]->thumbnail) }}">
                                            </div>
                                        </div>
                                        <div class="col d-flex flex-column gap-2">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="alt" name="story_alt" value="{{ $success_stories[0]->thumbnail_alt }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="name" name="story_name" value="{{ $success_stories[0]->name }}" onchange="checkInput()">
                                        </div>
                                        <div class="col">
                                            <label for="" class="form-label">
                                                Link
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col">
                                            <select class="select2" name="story_category" id="category" onchange="checkInput()">
                                                <option value=""></option>
                                                <option value="Admission Mentoring" {{ $success_stories[0]->category == 'Admission Mentoring' ? 'selected' : '' }}>Admission Mentoring</option>
                                                <option value="Passion Project" {{ $success_stories[0]->category == 'Passion Project' ? 'selected' : '' }}>Passion Project</option>
                                            </select>
                                        </div>
