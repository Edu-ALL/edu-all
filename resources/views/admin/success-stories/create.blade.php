                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="card-title">Create New Success Stories <span>| {{ now()->year }}</span>
                                    </h5>
                                ...
                                <form action="{{ route('create-success-stories') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <h5 class="card-title">Form General</h5>
                                    @if ($errors->any())
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Failed Create Success Stories!</strong> You have to check some fields in
                                    ...
                                    <div class="col d-flex flex-column gap-2">
                                            ...
                                            <div class="col d-flex flex-column gap-2">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="alt"
                                                        name="story_alt" value="{{ old('story_alt') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                            ...
                                            <div class="col d-flex flex-column gap-2">
                                                ...
                                                <div class="col-12">
                                                    <label for="" class="form-label">
                                                        Home Thumbnail Alt <span style="color: var(--red)">*</span>
                                                    </label>
                                                    <input type="text" class="form-control" id="alt"
                                                        name="story_home_alt" value="{{ old('story_home_alt') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="name" name="story_name"
                                                    value="{{ old('story_name') }}" onchange="checkInput()">
                                            </div>
                                            <div class="col">
                                                <label for="" class="form-label">
                                                    Link
                                                ...
                                                <input type="text" class="form-control" id="video_link"
                                                    name="story_video_link" value="{{ old('story_video_link') }}">
                                            ...
                                            <div class="col">
                                                <select class="select2" name="story_category" id="category"
                                                    ...
                                                    <option value="Admission Mentoring"
                                                        {{ old('story_category') == 'Admission Mentoring' ? 'selected' : '' }}>
                                                        ...
                                                        <div class="col d-flex flex-column gap-2">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('story_achievement_alt_en') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col d-flex flex-column gap-2">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ old('story_achievement_alt_id') }}">
...
@section('js')
    <script>
        ...
        function checkInput() {
            ...
            if (thumbnail == "" || alt == "" || name == "" || category == "" || badge1_en == "" || summary_description_en ==
                "" || description_en == "") {
