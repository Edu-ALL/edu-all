                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row align-items-center justify-content-between">
                                <h5 class="card-title mb-0">Create New As Seen <span>| {{ now()->year }}</span></h5>
                            ...
                            <form action="{{ route('create-as-seen') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="col py-3">
                                    @if ($errors->any())
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Failed Create As Seen!</strong> You have to check some fields.
                                        ...
                                        <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                            ...
                                            <div class="col d-flex flex-column gap-2">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="alt" name="alt" value="{{ old('alt') }}" required>
                                                    @error('alt')
                                                        <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                                    @enderror
                                                </div>
