                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="card-title">Universities <span>| {{ now()->year }}</span></h5>
                                    <a type="button" class="btn btn-primary" href="/admin/university/create">
                                        <i class="fa-solid fa-plus me-md-1 me-0"></i><span class="d-md-inline d-none">
                                            Create new</span>
                                    </a>
                                </div>
                                <table class="table display" id="listUniversity" style="width:100%">
                                    <thead>
                                        <tr>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body text-center mt-3 mb-1">
                    <p id="desc-info">Are you sure, you want to Delete this Universities?</p>
                </div>
...
@section('js')
    <script>
        ...
        function formDelete(id) {
            $('#form_delete').attr('action', '{{ url('/admin/university/delete/') }}' + '/' + id);
        };
        ...
        function changeOrder(id) {
            ...
            $.ajax({
                url: '{{ url('/admin/university/change-order') }}',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    id: id,
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        $('#listUniversity').DataTable().destroy();
                        getData();
                    } else {
                        $('#listUniversity').DataTable().destroy();
                        getData();
