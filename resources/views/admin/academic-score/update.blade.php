                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row align-items-center justify-content-between">
                                <h5 class="card-title mb-0">Update Academic Score <span>| {{ now()->year }}</span></h5>
                            ...
                            <form action="{{ route('update-academic-score', ['id' => $academic_score->id]) }}" method="POST">
                                @csrf
                                <div class="col py-3">
                                    @if ($errors->any())
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Failed Update Academic Score!</strong> You have to check some fields.
                                    ...
                                    <div class="col d-flex flex-row gap-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" id="subject"
                                                name="subject" value="{{ $academic_score->subject }}">
                                            @error('subject')
                                                <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
                                            @enderror
                                        </div>
