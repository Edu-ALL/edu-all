                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update-testimonial', ['group' => $testimonial[0]->group]) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col d-flex flex-column gap-2">
                                    <div class="col d-flex flex-md-row flex-column gap-md-3 gap-2">
                                        <div class="col-md-5">
                                            ...
                                            <input type="text" class="form-control" id="name" name="testi_name" value="{{ $testimonial[0]->testi_name }}">
                                        </div>
                                        <div class="col">
                                            <label for="" class="form-label">
                                            ...
                                            <div class="col">
                                                <select class="select2" name="testi_category" id="category" onchange="selectCategory()">
                                                    <option value=""></option>
                                                    <option value="Admissions Mentoring" {{ $testimonial[0]->testi_category == 'Admissions Mentoring' ? 'selected' : '' }}>Admissions Mentoring</option>
