                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($testimonial->testi_thumbnail)
                                                    <img src="{{ Storage::url('testimonial/'.$testimonial->created_at->format('Y').'/'.$testimonial->created_at->format('m').'/'.$testimonial->testi_thumbnail) }}" alt="EduALL" width="80" loading="lazy" decoding="async">
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td class="text-center">
                                                <img src="{{ asset('assets/img/flag/flag-'.$testimonial->lang.'.png') }}" alt="EduALL" width="30" loading="lazy" decoding="async">
