                                    ...
                                    <div class="col">
                                        ...
                                        <div class="col">
                                            <select class="select2" name="category" id="category">
                                                <option value=""></option>
                                                <option value="Event" {{ $upcoming_event->category == 'Event' ? 'selected' : '' }}>Event</option>
                                                <option value="Regular Talk" {{ $upcoming_event->category == 'Regular Talk' ? 'selected' : '' }}>Regular Talk</option>
                                            </select>
                                        </div>
                                        @error('category')
                                            <small class="alert text-danger ps-0 fs-12">{{ $message }}</small>
