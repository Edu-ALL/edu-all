                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-row align-items-center justify-content-between">
                                <h5 class="card-title mb-0">Create New SAT Score <span>| {{ now()->year }}</span></h5>
                            ...
                            <form action="{{ route('create-sat-score') }}" method="POST">
                                @csrf
                                <div class="col py-3">
                                    @if ($errors->any())
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong>Failed Create SAT Score!</strong> You have to check some fields.
