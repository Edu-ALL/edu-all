        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">SAT Score</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    <h5 class="card-title">List SAT Score <span>| {{ now()->year }}</span></h5>
                                    <a type="button" class="btn btn-primary" href="/admin/sat-score/create">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <div class="modal-body text-center mt-3 mb-1">
                    <p id="desc-info">Are you sure, you want to Delete this SAT Score?</p>
                </div>
...
@section('js')
    <script>
        ...
        function formDelete(id) {
            $('#form_delete').attr('action', '{{ url('/admin/sat-score/delete/') }}' + '/' + id);
        };
