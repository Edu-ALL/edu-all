...
@section('sub-navbar')
    ...
    ]" :active="__('pages/programs/univ_transfer_program.navbar_title')" title="{{ __('pages/programs/admission_mentoring.title') }}" />
@endsection

@section('content')
    {{-- ================================== Banner Section  ================================== --}}
    <section class="py-16 h-screen bg-transfer-header bg-cover bg-top" id="banner">
        <x-registration-form />
                ...
                <div class="flex flex-col md:flex-row gap-8 mt-6">
                    @foreach (__('pages/programs/univ_transfer_program.learning_scope_points') as $item)
                        <div class="w-full flex flex-col items-center justify-center">
                            ...
                            <x-button href="{{ asset('assets/files/programs/transfer/' . $item['link']) }}" target="_blank"
