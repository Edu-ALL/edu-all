...
<body>
        ...
        <div class="main grid md:grid-cols-5 grid-cols-1 p-0 m-0 md:h-[100vh] h-auto">
            <div class="md:col-span-3 section-1 h-full">
                ...
                <h5 class="leading-tight md:pr-8 md:mt-5 mt-4">
                    Discover the essential elements to maximize your chances of acceptance and unlock opportunities for
                                    ...
                                    <div class="ml-form-embedBody ml-form-embedBodyHorizontal row-form">
                                        <div class="ml-form-embedContent">
                                            ...
                                            <p class="title-2" style="text-align: center">
                                                <span style="font-size: 18px">Breaking Down the Journey to a Winning TOP
                                                    University Application</span>
                                                <br />
                                            </p>
                                        </div>

                                        <form class="ml-block-form"
                                            action="https://assets.mailerlite.com/jsonp/253019/forms/91386932023526960/subscribe"
                                            ...
                                            <div class="ml-form-formContent">
                                                ...
                                                <div class="ml-form-fieldRow">
                                                    <div class="ml-field-group ml-field-nama_anak ml-validate-required">
                                                        <!-- input -->
                                                        <input aria-label="nama_anak" aria-required="true"
                                                            type="text" class="form-control" data-inputmask=""
                                                            name="fields[nama_anak]"
                                                            placeholder="Child's name (if you are a student, then fill in this column with your name)"
                                                            autocomplete="" />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="ml-form-fieldRow">
                                                        <div
                                                            ...
                                                            <input aria-label="email" aria-required="true"
                                                                ...
                                                                name="fields[email]" placeholder="Email"
                                                                autocomplete="email" />
                                                        </div>
                                                    </div>
                                                    <div class="ml-form-fieldRow">
                                                        <div
                                                            class="ml-field-group ml-field-phone ml-validate-required">
                                                            <!-- input -->
                                                            <input aria-label="phone" aria-required="true"
                                                                type="text" class="form-control" data-inputmask=""
                                                                name="fields[phone]" placeholder="Phone number"
                                                                autocomplete="" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="ml-form-fieldRow">
                                                    <div class="ml-field-group ml-field-sekolah ml-validate-required">
                                                        <!-- input -->
                                                        <input aria-label="sekolah" aria-required="true"
                                                            type="text" class="form-control" data-inputmask=""
                                                            name="fields[sekolah]" placeholder="School"
                                                            autocomplete="" />
                                                    </div>
                                                </div>
                                                <div class="ml-form-fieldRow">
                                                    <div
                                                        ...
                                                        <!-- input -->
                                                        <input aria-label="study_destination" aria-required="true"
                                                            type="text" class="form-control" data-inputmask=""
                                                            name="fields[study_destination]"
                                                            placeholder="Study destination (ex: USA)"
                                                            autocomplete="" />
                                                    </div>
                                                </div>
                                                <div class="ml-form-fieldRow">
                                                ...
                                                <div class="ml-form-fieldRow">
                                                    <div
                                                        class="ml-field-group ml-field-promotion_source ml-validate-required">
                                                        <label>I know this event from:</label>
                                                        <!-- select -->
                                                        <select class="custom-select" name="fields[promotion_source]"
                                                            aria-label="promotion_source" aria-required="true">
                                                            <option value="">-</option>
                                                            <!-- Visible if current or any next has value -->
                                                            ...
                                                            <option>School's IG</option>
                                                            <option>Mentor/ Counselor</option>
                                                ...
                                                <div class="ml-form-fieldRow ml-last-item">
                                                    <div
                                                        ...
                                                        <label>
                                                            Have you ever participated in ALL-in
                                                        ...
                                                        <div class="custom-checkbox-radio-list">
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input aria-label="participated_in_all_in_eventprogram"
                                                                    ...
                                                                    value="Yes" id="radio-5812118-83}-0" />
                                                                <label class="custom-control-label"
                                                                    for="radio-5812118-83}-0">
                                                                    Yes
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input aria-label="participated_in_all_in_eventprogram"
                                                                    ...
                                                                    name="fields[participated_in_all_in_eventprogram]"
                                                                    class="custom-control-input" type="radio"
                                                                    value="No" id="radio-5812118-83}-1" />
                                                                <label class="custom-control-label"
                                                                    for="radio-5812118-83}-1">
                                                                    No
                                                                </label>
                                                            </div>
                                                        </div>
    ...
    <script>
        function ml_webform_success_5812118() {
            ...
            $('.ml-subscribe-form-5812118 .row-success').show();
            $('.ml-subscribe-form-5812118 .row-form').hide();
        }
    </script>
    <script src="https://groot.mailerlite.com/js/w/webforms.min.js?vc2affd81117220f6978e779b988d5128"
