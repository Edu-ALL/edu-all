...
@section('content')
        ...
        <div class="relative h-full">
            ...
            <div class="absolute left-0 w-full top-[27vh] md:top-[30vh]">
                <div class="new-main-container">
                    ...
                    <p class="text-xl md:text-2xl font-normal text-center lg:text-left max-w-3xl mx-auto lg:mx-0 mb-5 text-newprimary">
                        {{ __('pages/partnership_career.banner_subtitle') }}
                    </p>
    
                    <p class="text-newprimary text-base md:text-lg mb-4 md:mb-10 md:text-start text-center max-w-3xl"
                        itemprop="description">
                        {{ __('pages/partnership_career.banner_description') }}
                    </p>
    
                    <div class="flex md:justify-start justify-center">
                        <a href="#" class="rounded-full py-2 px-5 text-base md:text-lg bg-newprimary text-white inline-block">
            ...
            <div class="absolute w-full md:w-[50%] main-container top-[27vh] md:top-[30vh] right-0 hidden md:block">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-8 md:mt-10">
            ...
            <div class="bg-gradient-to-br from-newprimary to-newprimary/80 rounded-2xl relative overflow-hidden">
                ...
                <div class="p-4 md:p-5 relative z-10">
                    ...
                    <h3 class="text-white text-lg md:text-xl font-normal mb-3">
                        {{ $value['title'] }}
                    </h3>
    ...
    <section class="bg-gradient-to-b from-white to-blue-100 py-10 md:py-20 mt-10 md:mt-20">
        <div class="new-main-container">
            <div class="max-w-4xl mx-auto">
                <h2 class="text-3xl md:text-4xl text-center uppercase font-normal text-newprimary mb-5">
    ...
    <section class="bg-gradient-to-tr from-[#00020E] to-newprimary py-10 md:py-20">
        <div class="new-main-container mt-10 md:mt-20">
            ...
            <section class="py-10" id="career">
                <div class="new-main-container">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 items-center justify-between border-b border-b-[#393636] pb-4">
                        <div class="relative w-full">
                            <input type="text" name="search" placeholder="{{ __('pages/partnership_career.search_placeholder') }}"
                        ...
                        <div class="flex flex-col md:flex-row gap-3 md:gap-4 w-full justify-end">
                            <div class="relative flex-1 md:flex-none">
                                <select
                                    ...
                                    placeholder="{{ __('pages/partnership_career.department_label') }}" onchange="applyFilters()">
                                    <option value="" disabled selected hidden>{{ __('pages/partnership_career.department_label') }}</option>
                                    @if (!(request('department') == '' ? 'selected' : ''))
                                        <option value="" {{ request('department') == '' ? 'selected' : '' }}>{{ __('pages/partnership_career.all_department') }}
                                        </option>
                                    @endif
                            ...
                            <div class="relative flex-1 md:flex-none">
                                <select
                                    class="w-full md:w-44 pl-4 pr-10 py-2 rounded-full text-sm bg-[#EAEAEA] border border-newprimary appearance-none focus:outline-none cursor-pointer"
                                    placeholder="{{ __('pages/partnership_career.status_label') }}" onchange="applyFilters()">
                                    <option value="" disabled selected hidden>{{ __('pages/partnership_career.status_label') }}</option>
                                    @if (!(request('status') == '' ? 'selected' : ''))
                                        <option value="" {{ request('status') == '' ? 'selected' : '' }}>{{ __('pages/partnership_career.all_status') }}
                                        </option>
                                    @endif
