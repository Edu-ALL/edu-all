...
@section('content')
    <section class="bg-dark overflow-hidden">
        <div class="new-main-container relative">
            ...
            <div
                class="circular-gradient-2 absolute z-10 -right-full bottom-96 md:-right-[600px] md:-bottom-1/3 h-[700px] w-[700px] md:h-[1000px] md:w-[1000px]">
            </div>

            <div
                class="flex flex-col items-center justify-center w-full h-[60vh] mx-auto relative z-10 max-w-sm md:max-w-3xl">
