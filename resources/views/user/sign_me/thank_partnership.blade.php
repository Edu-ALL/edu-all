...
@section('content')
    <section class="bg-dark overflow-hidden">
        <div class="new-main-container relative">
            ...
            <div class="flex flex-col items-center justify-center w-full h-[60vh] mx-auto relative z-10 max-w-sm md:max-w-3xl">
                ...
                <h2 class="font-newprimary font-semibold md:text-xl text-base text-white text-center mt-4">
                    Our partnership team will review your details and reach out soon to discuss opportunities. Keep an eye on your email!
                </h2>
