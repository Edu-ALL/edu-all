                    ...
                    <div class="mx-auto md:max-w-4xl ease-in-out duration-500 z-[999999] flex flex-col items-center "
                        ...
                        <div class="flex items-center justify-between w-full my-4">
                            <div>
                                ...
                                <p class="text-white md:text-lg text-base mt-2">Let us know you better by filling out this
                                    form</p>
                            </div>
                                ...
                                <div class="">
                                    <div class="flex flex-col">
                                        ...
                                        <div class="mb-3 flex items-center justify-center">
                                            <button type="button"
                                                class="max-w-max bg-newprimary text-white text-center py-2 px-20"
                                                onclick="submitData()">
