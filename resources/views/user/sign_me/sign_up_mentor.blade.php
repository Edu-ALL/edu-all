...
@section('content')
    <section class="md:py-16 py-8 bg-dark overflow-clip">
        <div class="new-main-container relative z-10">
            ...
            <div class="circular-gradient-2 absolute z-10 -right-full bottom-96 md:-right-96 md:-bottom-1/3 h-[700px] w-[700px] md:h-[1000px] md:w-[1000px]"></div>
                    ...
                    <div class="md:w-1/2 w-full gap-4 flex flex-col order-2 md:order-1">
                        ...
                        <div class="border-[0.5px] border-[#6D6D6D] rounded-2xl py-6 px-6 h-full mt-2">
                            <div class="flex flex-col">
                                <h3 class="text-[#9C9C9C] text-3xl md:text-4xl font-bold mb-3 font-newprimary">Who We Are?</h3>
                                <p class="text-white text-sm leading-relaxed text-justify">
                                    EduALL offers integrative uni-prep and mentoring for middle & high school students to foster a growth mindset, develop academic & life skills, and facilitate access to high-quality education globally and real-world experiences, all while having fun in the process.
                                    <br>
                                ...
                                <p class="text-white text-sm leading-relaxed text-justify">
                                    We offer personalized 1-on-1 admissions mentoring service that will serve as an academic walk-through for students to get accepted at their dream schools and find best fit-universities.
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="flex space-x-4 items-center">
                                                <label class="inline-flex items-center flex-1 gap-2">
                                                    <input type="radio" class="form-radio w-6 h-6" name="mentor_type" value="full_time" required>
                                                    <span class="ml-2 text-white text-lg">Full-time</span>
                                                </label>
                                                <label class="inline-flex items-center flex-1 gap-2">
                                                    <input type="radio" class="form-radio w-6 h-6" name="mentor_type" value="part_time" required>
                ...
                <div class="flex flex-col md:flex-row gap-6 border-[0.5px] border-[#6D6D6D] rounded-2xl py-6 px-6 h-full">
                    <div class="flex flex-col flex-1">
                        <div class="flex flex-col md:flex-row md:items-center md:gap-5">
                            <h3 class="text-[#9C9C9C] text-3xl md:text-4xl font-bold mb-3 font-newprimary leading-4">Why Us?</h3> 
                            <span class="text-white md:text-base md:font-bold text-sm font-semibold">At EduALL, you'll enjoy</span>
                        </div>
                        <div class="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-4">
                            <div class="flex flex-col items-center gap-3 justify-center">
                                <img loading="lazy" src="{{ asset('assets/img/sign-me/sign-up-mentor/icons-01.webp') }}" alt="EduAll logo"
                                class="w-12 h-12 md:mx-0 mx-auto">
                                <span class="text-white text-xs max-w-[120px] text-center">An attractive compensation package</span>
                            </div>
                            <div class="flex flex-col items-center gap-3 justify-center">
                                <img loading="lazy" src="{{ asset('assets/img/sign-me/sign-up-mentor/icons-02.webp') }}" alt="EduAll logo"
                                class="w-12 h-12 md:mx-0 mx-auto">
                                <span class="text-white text-xs md:max-w-[150px] max-w-[120px] text-center">Hybrid working arrangement (2 days of WFO for Full-timers)</span>
                            </div>
                            <div class="flex flex-col items-center gap-3 justify-center">
                                <img loading="lazy" src="{{ asset('assets/img/sign-me/sign-up-mentor/icons-03.webp') }}" alt="EduAll logo"
                                class="w-12 h-12 md:mx-0 mx-auto">
                                <span class="text-white text-xs md:max-w-[100px] max-w-[120px] text-center">Opportunities for professional growth</span>
                            </div>
                            <div class="flex flex-col items-center gap-3 justify-center">
                                <img loading="lazy" src="{{ asset('assets/img/sign-me/sign-up-mentor/icons-04.webp') }}" alt="EduAll logo"
                                class="w-12 h-12 md:mx-0 mx-auto">
                                <span class="text-white text-xs max-w-[120px] text-center">A vibrant and collaborative workplace</span>
                            </div>
                            <div class="flex flex-col items-center gap-3 justify-center">
                                <img loading="lazy" src="{{ asset('assets/img/sign-me/sign-up-mentor/icons-05.webp') }}" alt="EduAll logo"
                                class="w-12 h-12 md:mx-0 mx-auto">
                                <span class="text-white text-xs max-w-[120px] text-center">Training and development to boost your skills</span>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col flex-1">
                        <h3 class="text-[#9C9C9C] text-3xl md:text-4xl font-bold mb-3 font-newprimary w-10 md:w-full">Role description</h3>
                        <div class="flex flex-col">
                            <ol class="list-decimal list-outside ml-4 text-white space-y-1 text-sm">
                                <li>Conduct individual sessions to understand each student's interests, academic and career aspirations</li>
                                ...
                                <li>Provide guidance on career paths and opportunities that align with their interest and goal</li>
