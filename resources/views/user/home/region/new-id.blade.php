...
@section('content')
    ...
    <section class="h-[100%]">
        <div class="relative h-full">
            ...
            <div class="absolute left-0 w-full main-container top-[27vh] md:top-[25vh]">
                ...
                <p class="text-white text-xl md:text-3xl mb-4 md:mb-0 md:text-start text-center" itemprop="description">
    ...
    <div class="relative">
            ...
            <div class="mt-12 md:mt-20">
                <div class="bg-[#F0F0F0] rounded-xl py-4 px-4 md:px-6 shadow-sm">
                    <div class="flex flex-col md:flex-row gap-4 md:gap-10 items-center justify-between">
                        <p class="text-base md:text-xl font-semibold text-center md:text-left">
                            What brings you to <br> EduALL today?
                        </p>
                        <div class="flex flex-col sm:flex-row items-center gap-2 md:gap-5">
                            <a href="#"
                                ...
                                Apply to University <i class="fas fa-arrow-right ml-1 md:ml-3"></i>
                            </a>
                            <a href="#"
                                class="py-2 px-4 md:py-3 md:px-6 bg-white text-newprimary rounded-full hover:bg-newprimary hover:text-white transition-all duration-300 text-xs md:text-base">
                                Looking For a Tutor <i class="fas fa-arrow-right ml-1 md:ml-3"></i>
                            </a>
                            <a href="#"
                                class="py-2 px-4 md:py-3 md:px-6 bg-white text-newprimary rounded-full hover:bg-newprimary hover:text-white transition-all duration-300 text-xs md:text-base">
                                Speak to a Consultant <i class="fas fa-arrow-right ml-1 md:ml-3"></i>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <section class="new-main-container px-4 md:px-10 mb-10 scroll-mt-28" id="program">
            <div class="bg-white shadow-md rounded-xl p-4 md:p-5 relative z-10">
                <div class="text-center max-w-4xl mx-auto">
                    <h2 class="text-2xl md:text-4xl text-black mb-3 md:mb-4 font-semibold" itemprop="headline">
                    ...
                    <div class="relative mt-4 md:mt-6 h-[87vh] md:h-[500px]">
                        ...
                        <div data-content="1"
                            ...
                            <div class="text-center py-5">
                                <h2 class="text-xl md:text-2xl text-black mb-3 md:mb-4 font-semibold">
            ...
            <div class="bg-gradient-to-tr from-black to-newprimary rounded-xl px-6 md:px-10 py-6 md:py-10 relative z-10">
                <div class="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-10">
                    <div class="w-full md:w-2/5">
                        <h2 class="w-full font-semibold text-white text-2xl md:text-4xl text-center md:text-left"
                            itemprop="headline">
                            Why <br> EduALL?
                        </h2>
                        ...
                        <div class="text-white accordion-group">
                            @foreach (__('pages/home.why_eduall.items') as $item)
                                <div class="border-b-2 overflow-hidden">
                                    <button
                                        class="accordion-btn w-full flex justify-between items-center py-4 text-left font-semibold">
        ...
        <section class="new-main-container relative z-10 py-6 md:py-10 mt-12 md:mt-20">
            <div class="text-center max-w-5xl mx-auto">
                <h2 class="text-2xl md:text-4xl font-semibold text-gray-800 uppercase mb-3 md:mb-4" itemprop="headline">
                    The EduALL Framework
                </h2>

                <p class="text-lg text-gray-500" itemprop="description">
                    From discovering your interests to securing university offers, our proven mentorship approach helps
                    students build the experiences and skills. See how we transform your unique potential into a standout,
        ...
        <div class="new-main-container h-full flex flex-col justify-center items-center relative z-10 py-8 md:py-0">
            <div
                ...
                <div class="text-center md:text-start w-full md:w-[65%] quiz-text">
                    <h3 class="text-lg md:text-2xl font-semibold text-newprimary mb-2">
                ...
                <div class="flex flex-col md:flex-row justify-between gap-6 md:gap-10 items-center cta-grid">
                    <div class="w-full md:w-1/2 text-white md:order-1 order-2">
                        ...
                        <p class="text-xs md:text-sm text-gray-500">
                            Book a free consultation to discuss your goals, evaluate your profile, and explore the most
                            effective path toward your best-fit universities.
                        </p>
    ...
    <section class="relative z-10 my-12 md:my-20">
        <div class="new-main-container p-5 md:p-10">
            <h2 class="text-2xl md:text-4xl font-semibold text-center mb-6 md:mb-10" itemprop="headline">
                Our Students Has Been Accepted to...
            </h2>
            ...
            <div class="relative max-w-4xl h-auto mx-auto">
                ...
                <div class="absolute top-[12%] left-[12%] group z-10">
                    <x-tooltip flag="fi fi-ca" flag-name="Canada" mentees="20" />
                </div>

                <div class="absolute top-[8%] left-[32%] group z-10">
                    <x-tooltip flag="fi fi-gb" flag-name="UK" mentees="20" />
                </div>

                <div class="absolute top-[25%] right-[25%] group z-10">
                    <x-tooltip flag="fi fi-cn" flag-name="China" mentees="20" />
                </div>

                <div class="absolute top-[25%] right-[13%] group z-10">
                    <x-tooltip flag="fi fi-jp" flag-name="Japan" mentees="20" />
                </div>

                <div class="absolute top-[42%] right-[16%] group z-10">
                    <x-tooltip flag="fi fi-sg" flag-name="Singapore" mentees="20" />
                </div>

                <div class="absolute bottom-[42%] right-[8%] group z-10">
                    <x-tooltip flag="fi fi-au" flag-name="Australia" mentees="20" />
                </div>

                <div class="absolute top-[25%] left-[20%] group z-10">
                    <x-tooltip flag="fi fi-us" flag-name="US" mentees="50" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="relative z-10 -mt-20 pb-10">
        <div class="new-main-container px-10">
            ...
            <div class="text-center">
                <p class="text-xl md:text-3xl text-gray-500 my-20">... and 200+ other universities.</p>
            </div>
        </div>
    </section>
        ...
        <div class="new-main-container py-6 md:py-10">
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-10 gap-4">
                ...
                <div class="flex gap-3 items-center justify-center md:justify-end flex-wrap">
                    <a href="#"
                        class="bg-white text-blue-500 hover:bg-[#00003F] hover:text-white px-5 py-1 rounded-full">All</a>
        ...
        <div class="new-main-container px-4 md:px-5 lg:px-20 pt-12 md:pt-20">
            <div class="flex flex-col md:flex-row items-center">
                <div class="w-full md:w-2/5 text-center md:text-start mb-5">
                    <h2 class="text-blue-500 text-base md:text-lg mb-3 md:mb-5" itemprop="headline">FAQ's</h2>
                    <h3 class="text-2xl md:text-4xl font-semibold leading-5 mb-3 md:mb-5" itemprop="headline">Find Your
                        Answers Here</h3>
                    <p class="text-gray-500 text-base md:text-lg" itemprop="description">Couldn't not find what you were
                        looking for? </p>
                </div>

                <div class="w-full md:w-3/5">
                    <div class="accordion-group">
                        @foreach (__('pages/home.faq') as $item)
