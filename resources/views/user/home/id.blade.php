...
@section('content')
                            ...
                            <div
                                ...
                                <div class="px-8 lg:px-40 2xl:px-44 font-primary">
                                    ...
                                    <a href="{{ $banner->banner_link }}"
                                        class="inline-block mt-10 bg-[#7895C7] py-2.5 px-8 rounded-lg font-bold text-white text-base capitalize">{{ $banner->banner_button }}</a>
                                </div>
                            </div>
    ...
    <section class="relative mx-6 md:h-0">
        <div
            class="max-w-3xl w-full bg-white rounded-lg shadow-[0px_0px_10px_5px] shadow-black/20 md:absolute-center md:-top-[250px]">
    ...
    <section class="pt-24 max-w-4xl w-full px-6 mx-auto my-20">
        <div class="flex flex-col items-center">
            <h2 class="mb-6 font-primary font-semibold text-2xl text-center text-[#7895C7]">Tentang Kami</h2>
            <p class="mb-6 font-primary font-medium text-base text-center text-[#7A7A7A]">Kami membimbing siswa yang
                ingin
                melanjutkan pendidikan tinggi di luar negeri dan menempatkan mereka di universitas-universitas yang
                paling
                cocok. Kami menyediakan bimbingan mentoring yang sesuai dengan kebutuhan anda, dimanapun anda berada.
            </p>
    ...
    <section class="py-10">
        <div class="max-w-3xl w-full mx-auto px-6 mb-10 flex flex-col items-center">
            <h2 class="mb-6 font-primary font-semibold text-2xl text-center text-[#7895C7]">Our Program</h2>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var splide = new Splide('.splide', {
                height: isSmallDevice ? '70vh' : '80vh',
                wheel: false,
                isNavigation: false,
                arrows: false,
                type: 'fade',
