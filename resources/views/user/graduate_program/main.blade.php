            ...
            <div class="flex flex-col items-stretch gap-6 -mt-8 pl-4 pr-4 lg:pl-0 lg:pr-20 xl:pr-40 lg:flex-row">
                ...
                <div class="flex flex-col gap-4 w-full py-12 lg:w-1/2">
                    @foreach (__('pages/programs/graduate_program.do_list') as $item)
                        <div
                            class="flex justify-between items-stretch gap-4 w-full min-h-full rounded-lg bg-gradient-to-r from-[#0000FF] via-primary to-[#0000FF] overflow-hidden lg:rounded-full lg:min-h-max">
                            <div
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="flex flex-col items-center mt-16">
                    ...
                    <a href="https://drive.google.com/file/d/1nfWX8pUvE3YApEix6WHb-W_ZQ0hBZZg_/view?usp=sharing"
                        ...
                        <span
                            class="px-6 py-2 font-newprimary font-semibold text-white text-center rounded-md bg-[#F90C0C]">{{ __('pages/programs/graduate_program.pilar_btn') }}
                        </span>
                    </a>
                    <a href="{{ route('sign_me_adm_mentoring', ['locale' => app()->getLocale()]) }}" target="_block"
                        ...
                        <img data-original="{{ asset('assets/img/admission mentoring/Graduate/Graduate IC.webp') }}"
                            alt="EduALL Graduate" class="mt-12 w-full max-w-2xl mx-auto object-contain">
                    </a>
                </div>
            </div>
        </div>
