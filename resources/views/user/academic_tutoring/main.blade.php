...
@section('content')
    ...
    <section id="benefit" class="py-10">
        <div class="flex flex-col gap-y-6 main-container">
            ...
            <div class="grid grid-cols-1 gap-8 md:items-start md:justify-center md:grid-cols-3 ">
                <div class="flex flex-col items-center">
                    <div
                        ...
                        <h2
                            class="animation_circle_persentage absolute font-newprimary font-black text-4xl text-newprimary text-center -rotate-[270deg]">
                            0%
                        </h2>
                    </div>
                    <p class="font-newprimary font-bold text-[22px] text-newprimary text-center leading-6">
            ...
            <div class="flex flex-col items-center mt-12">
                <h2 class="mb-6 font-newprimary font-black text-5xl text-black text-center">
                                    ...
                                    <ul class="list-outside pr-6">
                                        @foreach ($item['desc'] as $desc)
                                            <li class="inline-flex text-white">
                                                ...
                                                <p
                                                    class="font-newprimary font-normal text-[17px] text-white leading-5 md:pr-4">
                                                    {{ $desc }}</p>
                                            </li>
                                        @endforeach
                                    </ul>
    ...
    <section class="py-10">
        <div class="flex flex-col">
            ...
            <div class="main-container mb-12 text-center md:text-left">
                <p class="font-newprimary font-semibold text-2xl text-newprimary">
            ...
            <div class="grid grid-cols-1 main-container gap-8 md:grid-cols-3">
                <div class="flex flex-col px-4 py-6 items-center rounded-3xl bg-[#ecf1ff]">
                    <h4 class="font-newprimary font-extrabold text-2xl text-newprimary text-center">
                    ...
                    <ul class="mt-2">
                        @foreach (__('pages/programs/academic_tutoring.private_list_basic_body') as $item)
                            <li class="flex my-2"><i class="fa-solid fa-check mr-2 mt-1.5 text-yellow "></i>
                                <p class="font-newprimary font-medium text-xl text-yellow">{{ $item }}</p>
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="flex flex-col px-4 py-6 items-center rounded-3xl bg-[#efaa52]">
                    <h4 class="font-newprimary font-extrabold text-2xl text-white text-center">
                    ...
                    <ul class="mt-2">
                        @foreach (__('pages/programs/academic_tutoring.private_list_pro_body') as $item)
                            <li class="flex my-2"><i class="fa-solid fa-check mr-2 mt-1.5 text-black "></i>
                                <p class="font-newprimary font-medium text-xl text-black">{{ $item }}</p>
                            </li>
                        @endforeach
                    </ul>
                </div>
            ...
            <div class="main-container mt-8 text-center">
                <a href="{{ route('sign_me_acad_tutoring', app()->getLocale()) }}"
                    class="inline-block px-5 py-2 mt-10 font-newprimary font-bold text-xl text-white text-center bg-newyellow rounded-lg">
                    ...
                    @foreach (__('pages/programs/academic_tutoring.why_us_list') as $item)
                        <li class="flex flex-col mb-4 rounded-[2.75rem] bg-[#f6d7af] overflow-hidden">
                            ...
                            <div class="flex flex-col p-6">
                                <h5 class="mb-4 font-newprimary font-bold text-2xl text-newprimary">{{ $item['title'] }}</h5>
                                <p class="font-newprimary font-lg text-black">{{ $item['desc'] }}</p>
                            </div>
                        </li>
                    @endforeach
                </ul>
                            ...
                            @foreach ($tutors as $tutor)
                                <li class="splide__slide h-ful">
                                    <div class="splide__container h-full">
                                        <div
                                            class="flex flex-col h-full mx-4 mb-4 rounded-[3rem] bg-newprimary overflow-hidden">
                                            ...
                                            <div class="flex flex-col justify-between p-6">
                                                <h5 class="mb-4 font-newprimary font-bold text-2xl text-yellow">
                                                    {{ $tutor->full_name }}
                                                </h5>
                                                <div class="flex flex-col">
                                                    <p class="mt-2 font-newprimary font-semibold text-base text-white">
                                                        {{ $tutor->experience }}
                                                    </p>
                                                    <div class="font-newprimary font-medium text-base text-yellow">
                                                        {!! $tutor->subject !!}
                                                    </div>
                                                </div>
                                            </div>
    ...
    <section class="py-10">
        <div class="main-container flex flex-col items-center">
            ...
            <a href="{{ route('sign_me_acad_tutoring', app()->getLocale()) }}"
                class="px-5 py-2 mt-4 font-newprimary font-bold text-xl text-white text-center bg-newyellow rounded-2xl">{{ __('pages/programs/academic_tutoring.bottom_btn') }}</a>
        </div>
