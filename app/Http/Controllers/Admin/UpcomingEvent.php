...
class UpcomingEvent extends Controller
{
    ...
    public function store(Request $request){
        ...
        DB::beginTransaction();
        try {
            $upcoming_event_en = new UpcomingEvents();
            $upcoming_event_en->group = date('YmdHis');
            ...
            $upcoming_event_en->event_status = 'active';
            $upcoming_event_en->lang = 'en';
            $upcoming_event_en->save();

            $upcoming_event_id = new UpcomingEvents();
            $upcoming_event_id->group = $upcoming_event_en->group;
            ...
            $upcoming_event_id->event_status = 'active';
            $upcoming_event_id->lang = 'id';
