<?php
return [
    'meta_title' => 'ALL-in Eduspace SAT Preparetion Program - Sign Up Today',
    'meta_description' => 'Submit your profile to get contacted by our team about study abroad & our SAT Preparations Program that help our mentees study to Top Universities',
    'qna_list' => [
        [
        ...
        [
            ...
            'answer' => 'During the test, you will do the 4 sections that divide into English and Math sections according to the SAT. You will be supervised with the timer according to each section. This test aims to measure your current knowledge and understanding of the SAT, so make sure you are taking the test thoroughly.',
        ],
        [
            'question' => 'What should I do in the SAT Diagnostic Test?',
            'answer' => 'You should follow the proctor\'s instructions to: <br>
                    - Open your camera during the online test.
                    <br>
                - Prohibited from taking the SAT Diagnostic Test before the specified time.
                <br>
                - Not cheat, because this test aims to assess your current level.',
        ],
        [
