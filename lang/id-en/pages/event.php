...
return [
    'meta_title' => "Events & Initiatives | EduALL",
    ...
    'section_title' => 'Events and Initiatives',
    'section_subtitle' => 'Each initiative brings students together with educators, universities, industry leaders, and community partners through experiences designed to inspire, challenge, and prepare them for what\'s next.',
    ...
    'story_section' => [
        'title' => 'The Story Behind Our Events',
        'description' => 'Every event starts with the same belief: students become game changers through real experiences. Every conference, showcase, and community initiative gives them the chance to meet new people, test their ideas, and take on challenges beyond the classroom.',
    ],

    'cta_section' => [
        'title' => 'Your Next Initiative <br> <span class="font-[playfair]">Starts Here</span>',
        'description' => 'Whether you have a new idea or want to bring an existing EduALL initiative to your school, company, or community, we\'d love to hear from you. Share your goals, and let\'s explore how we can bring it to life together.',
