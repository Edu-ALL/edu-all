...
return [
    ...
    'achievment' => [
        ...
        [
            'value' => '$2.5 Million+',
            'label' => 'in Scholarship Awards',
        ],
        [
            'value' => '200',
            'label' => 'Impact Projects Launched by EduALL Mentees',
        ],
        [
            'value' => '100%',
            'label' => 'Acceptance Rate to Universities Worldwide',
        ],
    ],
    ...
    'about_us' => [
        ...
        'items' => [
            [
                ...
                'description' => 'Deeply personalized university admissions guidance designed around your goals and aspirations.',
            ],
            [
                'img' => 'Globe.webp',
                'title' => 'Professional Network',
                'description' => 'Learn from mentors with firsthand admissions experience at leading global universities.',
            ],
            [
                'img' => 'Shield.webp',
                'title' => 'Student Community',
                'description' => 'Grow through meaningful projects, student clubs, and exclusive events that strengthen your university profile.',
            ]
        ],
    ],
    ...
    'program' => [
        ...
        'mentoring' => [
            ...
            'title' => 'Build a Standout Application Profile',
            'description' => 'End-to-end strategic mentorship for students applying to top universities worldwide. From profile building and personal statement coaching to university selection and application strategy, we guide every step.',
            'features' => [
        ...
        'academy' => [
            ...
            'description' => 'For students in Grades 7–12, our internationally certified tutors provide personalized academic support across IB, Cambridge, and AP curricula, with SAT preparation included.',
            'features' => [
                '1-on-1 Subject Tutoring <br> (IB, Cambridge, AP)',
                'Target-Driven SAT Preparation <br> (Private & Group Class)',
                'International Olympiad Training <br> (Math & Science)',
            ],
        ],
    ],
    ...
    'why_eduall' => [
        ...
        'items' => [
            [
                'title' => 'Mentors from Top Global Universities',
                'description' => 'Learn from mentors who have successfully navigated the admissions process at leading universities including the University of Pennsylvania, University College London, King\'s College London, the University of Edinburgh, and the University of Sydney. Their firsthand experience helps students make informed decisions and build stronger applications.',
            ],
            [
                'title' => 'End-to-End Essay Support',
                'description' => 'From brainstorming to final revisions, our mentors provide unlimited guidance throughout the essay-writing process, helping students communicate their stories with clarity and confidence.',
            ],
            [
    ...
    'quiz' => [
        'title' => 'Find the Right Study Abroad Program for You',
        'description' => 'Not sure where to begin? Take our 5-minute quiz and get personalized university recommendations based on your academic background, university goals, and study abroad aspirations.',
        'cta' => 'Take the Quiz',
    ],

    'testimoni' => [
        'title' => 'Meet Our EduALLumni',
