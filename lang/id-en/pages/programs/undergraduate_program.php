...
return [
    'meta_title' => "Undergraduate Preparation Program for Study Abroad - EduAll",
    'meta_description' => 'Enroll in our undergraduate preparation program for study abroad, featuring a comprehensive curriculum and expert mentors to support your university admission journey.',

    'navbar_title' => "UNDERGRADUATE",
    'title' => "UNDERGRADUATE",
    'body' => "UNIVERSITY ADMISSION MENTORING",

    "description" => "We offer a personalized 1-on-1 admission mentoring service that will serve as an academic walk-through for students to get accepted at their dream schools and find best-fit universities.",
